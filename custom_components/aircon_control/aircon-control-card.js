  ...
  render() {
    ...
    const sensorsHtml = `
      <div class="sensor-row">
        <div class="sensor-item">Solar: ${solar}</div>
        <div class="sensor-item">Outside Temp: ${outsideTemp}°</div>
        <div class="sensor-item">Outside Humidity: ${outsideHumidity}%</div>
        <div class="sensor-item">House Temp: ${houseTemp}°</div>
        <div class="sensor-item">House Humidity: ${houseHumidity}%</div>
      </div>
    `;
